...
const ImageClipBox = ({ src, clipClass }: { src: string; clipClass: string }) => (
  <div className={clipClass}>
    <Image src={src} alt='contact' width={0} height={0} sizes='100vw' className='w-full h-auto' />
  </div>
);
    ...
    <div id='contact' className='my-20 min-h-96 w-screen  px-10'>
      <div className='relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden'>
        ...
        <div className='flex flex-col items-center text-center'>
          ...
          <AwardTitle title='let&#39;s b<b>u</b>ild the <br /> new era of <br /> g<b>a</b>ming t<b>o</b>gether.' />

          <AwardButton id='contact' title='contact us' containerClass='mt-10 cursor-pointer' />
        </div>
      </div>
    </div>
  );
